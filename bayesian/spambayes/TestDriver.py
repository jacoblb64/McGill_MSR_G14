...
class Driver:
    ...
    def set_classifier(self, classifier):
        ...
        # https://mail.python.org/pipermail/spambayes/2013-January/023267.html
    ...
    def test(self, ham, spam, all_ratios):
        c = self.classifier
        t = self.tester
        local_ham_hist = Hist()
        ...
        def new_ham(msg, prob, lo=options["TestDriver", "show_ham_lo"],
            ...
            msg_id = os.path.splitext(os.path.basename(msg.tag))[0]
            all_ratios.append(msg_id + ",ham,"+ str(prob))
        ...
        def new_spam(msg, prob, lo=options["TestDriver", "show_spam_lo"],
            ...
            msg_id = os.path.splitext(os.path.basename(msg.tag))[0]
            all_ratios.append(msg_id + ",spam,"+ str(prob))
